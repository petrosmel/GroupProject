...
CREATE TABLE `company_image` (
  ...
  KEY `fk_table1_image_url1_idx` (`image_url_id`),
  KEY `fk_table1_company2_idx` (`company_id`),
  CONSTRAINT `fk_table1_company2` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`),
  CONSTRAINT `fk_table1_image_url1` FOREIGN KEY (`image_url_id`) REFERENCES `image_url` (`id`)
